...
@router.post(
    ...
    status_code=201,
    dependencies=[Depends(require_permission(PermissionsEnum.CAN_CREATE_BUILDING))],
)
...
@router.get(
    ...
    dependencies=[Depends(require_permission(PermissionsEnum.CAN_READ_BUILDING))],
)
...
@router.put(
    ...
    response_model=BuildingResponse,
    responses={404: {"model": ErrorModel}},
    dependencies=[Depends(require_permission(PermissionsEnum.CAN_UPDATE_BUILDING))],
)
...
@router.delete(
    ...
    response_model=BuildingResponse,
    responses={404: {"model": ErrorModel}},
    dependencies=[Depends(require_permission(PermissionsEnum.CAN_DELETE_BUILDING))],
)
